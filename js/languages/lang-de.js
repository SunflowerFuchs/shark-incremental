// This is certainly not English! It's German!
...
LANGUAGES.DE = {
    ...
    text: {
        ...
        'fish-name': "Fische",
        'fish-costName': toTextStyle('Fische','fish'),

        'prestige-name': "Prestige-Splitter",
        'prestige-costName': toTextStyle('Prestige','prestige') + "-Splitter",

        'coral-name': "Korallen",
        'coral-costName': toTextStyle('Korallen','coral'),

        'ice-name': "Eis",
        'ice-costName': toTextStyle('Eis','ice'),

        'salt-name': "Salz",
        'salt-costName': toTextStyle('Salz','salt'),

        'snow-name': "Komprimierter Schnee",
        'snow-costName': toTextStyle('Komprimierter Schnee','snow'),

        'kelp-name': "Seetang",
        'kelp-costName': toTextStyle('Seetang','kelp'),

        'core-name': "Magmatische Fragmente",
        'core-costName': toTextStyle('Magmatische','core') + ' Fragmente',

        'humanoid-name': "Humanoide Haie",
        'humanoid-costName': toTextStyle('Humanoide','humanoid') + ' Haie',

        'full-shark-level': toTextStyle('Hai','shark') + '-Level',

        'sharkoid-faith': toTextStyle('Hai-liger Glaube','humanoid'),
        ...
        'radioactive-name': toTextStyle('Radioaktivität '+icon("radioactive"),'core'),

        // Tabs

        'tab-shark': toTextStyle('Haie','shark'),
        'tab-options': "Einstellungen",
        'tab-auto': "Automatisierung",
        'tab-research': toTextStyle('Forschung','prestige'),
        'tab-explore': "Erkundung",

        'tab-core': toTextStyle('Kern','core'),
        'tab-core-reactor': toTextStyle('Kern','core')+"reaktor",
        'tab-core-radiation': toTextStyle('Kern','core')+"strahlung",
        'tab-core-assembler': toTextStyle('Kern','core')+"aufbau",

        'tab-evolution': toTextStyle('Evolution','humanoid'),
        'tab-shark-rank': toTextStyle('Hai','shark') + "-Rang",
        'tab-evolution-tree': toTextStyle('Evolution','humanoid') + "s-Baum",
        'tab-evolution-goal': toTextStyle('Evolution','humanoid') + "s-Ziele",
        'tab-cultivation': "Bewirtschaftung",

        // Elemente

        'fish-div': `Deine ${toTextStyle('Haie','shark')} haben <h2>${toTextStyle('0','fish','fish-amount')}</h2> <span id="fish-gain"></span> Fische gefressen.`,
        'shark-stats': `${toTextStyle('Hai','shark')}-Statistiken<br>Level: <h4 id="shark-level">???</h4><br>Rang: <h4 id="shark-tier">???</h4> <span id="shark-next-rank"></span>`,

        'shark-elo-div': `Dein ${toTextStyle('Hai','shark')}-ELO ist <h3>${toTextStyle('0','humanoid','shark-elo')}</h3>.`,
        'shark-rank-div': `Dein ${toTextStyle('Hai','shark')}-Rang ist <h3 id="shark-rank">0</h3>.`,
        'shark-rank-req-div': `Der nächste Rang benötigt ${toTextStyle('Hai','shark')}-ELO <h4>${toTextStyle('0','humanoid','shark-rank-req')}</h4>.`,
        'shark-rank-note': `Note: Hai-Rang wird zurückgesetzt wenn du ein Evolutions-Reset auslöst.`,

        'option-title-1': "Haupteinstellungen",
        'option-title-2': "Notationen",
        'option-title-3': "Bestätigungen",
        'option-title-4': "Sprachen",

        'offline-speed': "Offline-Zeit beschleunigen",
        'offline-done': "Fertig",

        'radioactive-div': `Der ${toTextStyle('Kern','core')} hat <h3>${toTextStyle('0 / 1,000 '+icon("radioactive"),'core','radioactive-amount')}</h3> ausgestrahlt <span id="radioactive-gain"></span>.`,
        get 'radioactive-summary'() {
            var rf = toTextStyle('Fische '+icon("radioactive"),'fish')
            return `
            <summary>Das ${toTextStyle('Kern','core')}strahlungs-Experiment</summary>
            Mit Kernstrahlung zu experimentieren erzwingt einen ${toTextStyle('Core','core')}-Reset. 
            Während du experimentierst, ist der Kernreaktor abgeschalten. ${toTextStyle('Fische','fish')}, ${toTextStyle('Prestige','prestige')}-Splitter, und die Rohstoffe der ersten vier Ozeane werden Kubikwurzelt.
            Das Experiment zwingt deine ${toTextStyle('Haie','shark')} dazu, radioaktive ${rf} zu fressen.<br>
            Je mehr ${rf}, desto mehr ${toTextStyle('Strahlung '+icon("radioactive"),'core')} wird generiert, welche dir zusätzliche Schübe gibt.
            `
        },
        'radioboost-div': `Du hast <h3 id="radioactive-boost">0</h3> radioaktive Schübe.`,
